...
#load wax data
wax.data <- read.csv("data_pocillopora_timeseries/1_January_2022/1_surface_area_data.csv", header=TRUE)
...
smpls%>%
  ...
  select(colony_id, surface.area.cm2, timepoint)%>%
    write_csv("data_pocillopora_timeseries/1_January_2022/1_surface.area.calc.csv")
```
