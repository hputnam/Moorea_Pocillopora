...
# Run ANOVA for each parameter *** this is where I am currently working
```{r}
## Test for differences in salinity by treatment with two-way ANOVA
res.aov <- aov(treatment ~ timepoint, data = carb.output)
summary(res.aov)
