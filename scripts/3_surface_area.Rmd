...
#load wax data
wax.data <- read.csv("data_pocillopora_timeseries/3_March_2022/3_surface_area_data.csv", header=TRUE)
...
smpls%>%
  ...
  select(colony_id, surface.area.cm2, timepoint)%>%
    write_csv("data_pocillopora_timeseries/3_March_2022/3_surface.area.calc.csv")
```
