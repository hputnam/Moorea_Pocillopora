...
prot_path = "data/protein/holobiont/"                                              # Path to prot data directory
...
prot %>%
  ...
  ggplot(aes(x = site.x, y = prot_mg.cm2)) +
  facet_wrap(~timepoint.x)  +
  #coord_cartesian(ylim = c(0, 10))+
  labs(x = "", y = "Holobiont soluble protein (mg/cm2)") +
