---
title: "January 2022 host and holobiont protein analysis"
...
prot_path = "January_2022/data/2_protein/2_host/"                                              # Path to prot data directory
...
prot_host %>%
  ...
  write_csv(., path = "January_2022/output/2_host_protein.csv")
```
...
```{r}
# List protein data files 
prot_path = "January_2022/data/2_protein/2_holobiont/"                                              # Path to prot data directory
all_prot_files <- list.files(path = prot_path, pattern = "*.csv")          # List all files in directory
prot_platemaps <- list.files(path = prot_path, pattern = "platemap")       # List platemap files
prot_data_files <- setdiff(all_prot_files, prot_platemaps)                 # List data files
